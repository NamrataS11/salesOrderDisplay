		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "sales order",
									"targetURL": "#appsalesorderdisplaybatch12-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appsalesorderdisplaybatch12-display": {
								"semanticObject": "appsalesorderdisplaybatch12",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=app.salesorderdisplaybatch12",
									"url": sap.ui.require.toUrl("app/salesorderdisplaybatch12")
								}
							}
						}
					}
